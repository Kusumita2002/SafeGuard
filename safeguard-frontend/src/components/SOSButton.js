...
const EmergencySOS = ({ user, disabled }) => {
  ...
  const triggerSOS = async () => {
    if (disabled) {
      setStatus('Please accept the permission checkbox first.');
      return;
    }
    ...
    try {
      ...
      // 3. Take photo using ImageCapture
      ...
      // 4. Separate audio recording (optional extra file)
    ...
    <div className="sg-sos-layout">
      ...
      <div className="sg-sos-cards">
        ...
        <div className="sg-card sg-sos-gps-card">
          ...
          <div className="sg-sos-map-placeholder">
            {photoUrl && (
              <img
                src={photoUrl}
          ...
          <div className="sg-sos-gps-buttons">
            <button
        ...
        {/* Upload card (visual only) */}
        <div className="sg-card sg-sos-upload-card">
          <h3>Share Photos/Videos</h3>
          <div className="sg-sos-upload-buttons">
            <button className="sg-btn sg-upload-photo-btn">Upload Photo</button>
            <button className="sg-btn sg-upload-video-btn">Upload Video</button>
          </div>
          <p className="sg-sos-note">
            On SOS, your live location, photo, video and voice are shared
            automatically.
          </p>
        </div>
      </div>
